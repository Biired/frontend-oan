...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    },*/
    {
      ...
      active: false,
      children: [
        { path: "/widgets/general", title: "Accueil", type: "link" },
        { path: "/widgets/chart", title: "Statistiques", type: "link" },
        { path: "/widgets/chart", title: "Tableau de bord", type: "link" },
      ],
    },
    {
      title: "GÉORÉFÉRENCEMENT",
      icon: "map-marker custom-sidebar-icon-small",
      type: "sub",
      active: false,
      children: [
        { path: "/widgets/general", title: "Sous-menu 1", type: "link" },
        { path: "/widgets/chart", title: "Sous-menu 2", type: "link" }
      ],
    }
    ,
    {
    ...
    },
    {
      ...
      icon: "lightbulb-o custom-sidebar-icon-small",
      type: "sub",
      active: false,
      children: [
        { path: "/widgets/general", title: "Sous-menu 1", type: "link" },
    ...
    ,
    {
      ...
      active: false,
      children: [
        { path: "/widgets/general", title: "Comptes", type: "link" },
        { path: "/widgets/chart", title: "Groupes", type: "link" }
      ],
    }
    /*{
